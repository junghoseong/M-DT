...
class Prompt(nn.Module):
    ...
    def __init__(self, length=6, embed_dim=128, top_k=5, pool_size=40, dropout_rate=0.1, embed_key='last',
    ...
    def add_counts(self, idx):
        ...
        with torch.cuda.amp.autocast():
            ...
            idx_counts = idx_counts // idx_counts.sum() # change to adapt python3 version
            self.counts_total += 1
